 ...
 *
 * PRÉREQUIS:
 * 1. Créer un repo GitHub public nommé "music-storage"
 * 2. Créer un Personal Access Token sur GitHub avec permissions "repo"
 * 3. Ajouter la dépendance Gson dans pom.xml
 */
public class GitHubFileUploader {

    // ⚠️ NE JAMAIS mettre email/password en dur dans le code!
    // À la place, on utilise un Personal Access Token
    ...
    public static String uploadFileGitHub(String localFilePath, String targetFolder) {
        try {
            ...
            String apiUrl = String.format(
                    ...
                    GITHUB_USERNAME, REPO_NAME, remotePath
            );
            ...
            if (response.statusCode() == 201) {
                ...
                System.err.println("❌ Repository non trouvé - Créez d'abord le repo '" + REPO_NAME + "'");
                return null;
